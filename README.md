...
Acknowledgments: thanks to your supervisor, your institution, the open-source libraries used in this project, and the public datasets and model references that made the ML components possible.
